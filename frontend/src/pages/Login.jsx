...
import { BUSINESS_TYPES } from "../lib/utils.js";
...
export default function Login() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      if (mode === "signup") {
        await authService.signup({ email, password, businessName, businessType, ownerName });
      } else {
    ...
    <div className="auth">
      <div className="auth__statusbar" aria-hidden="true">
        ...
        <span className="auth__statusbar-icons">
          ...
          <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
            <path
              d="M3 13.5A16.5 16.5 0 0 1 21 11"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
            />
            <path
              d="M3 18A11 11 0 0 1 21 16"
              stroke="currentColor"
              strokeWidth="1.6"
              strokeLinecap="round"
              opacity="0.7"
        ...
        <div className="auth__side-inner">
          ...
          <div className="auth__side-body">
            <blockquote className="auth__quote">
              “We found out about our wait-time problem within a week. Fixing it
              directly raised our 4.1 to 4.6 stars.”
            </blockquote>
            <p className="auth__quote-author">
              Sarah Johnson — Owner, Rite Restaurant
            </p>
            ...
            <div className="auth__side-stats">
              {SIDE_STATS.map((stat) => (
                <div key={stat.label} className="auth__side-stat">
                  ...
                  <strong className="auth__side-stat-value">
                    {stat.value}
                  </strong>
      ...
      <main className="auth__panel">
        <div className="auth__card">
          ...
          <form className="auth__form" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="btn btn-primary rounded-sm btn-block btn-lg"
              disabled={submitting}
            >
              {submitting
                ? "Signing in…"
          ...
          <div className="auth__demo">
            ...
            <button
              type="button"
              className="btn rounded-sm btn-outline btn-block"
          ...
          <p className="auth__demo-note">
            Demo mode — authentication goes through authService, mocked for the
            hackathon. No real account is created.
          </p>
        </div>
