  ...
  return (
    ...
    >
      <ul
        ref={scrollerRef}
        className={cn(
          "flex  w-[370px]  min-w-full shrink-0 flex-nowrap gap-4 py-4",
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[350px] max-w-full shrink-0 rounded-2xl border border-[#630ED4] bg-white px-8 py-6 h-[450px] md:w-[450px] dark:border-zinc-700 dark:bg-[linear-gradient(180deg,#27272a,#18181b)]"
            key={item.name}
          >
